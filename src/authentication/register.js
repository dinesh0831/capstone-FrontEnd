                    ...
                    <Box  sx={{ height: "max-content", width: 250, bgcolor: "white", marginTop: 20, marginLeft: 20, borderRadius: 2, display: "block", justifyContent: "center", position: 'absolute' }} >
                        ...
                        <Box sx={{ display: "flex-inline", }}>
                            ...
                            <form onSubmit={this.handleSubmit}>
                                ...
                                <TextField sx={{ margin: 1 }} id="outlined-basic" onChange={this.handleChange} placeholder="[Aa-Zz] or [1-9]or Both " name="password" value={this.state.password } label="Password" type="password" variant="outlined" />
